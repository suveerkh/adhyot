  ...
  return (
    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 68 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 36 }} className="lp-desktop">
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }} className="lp-desktop">
          {user ? (
      ...
      {/* Hamburger */}
          <button className="lp-mobile" onClick={() => setMobileOpen(true)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#08060d', padding: 4, display: 'none', alignItems: 'center' }}>
  ...
  return (
    <footer style={{ background: '#08060d', color: '#9ca3af', padding: '60px 5% 32px' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="footer-bottom" style={{ borderTop: '1px solid #1f2937', paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          .cta-btns button { width: 100% !important; max-width: 100% !important; }
